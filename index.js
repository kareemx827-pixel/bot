        ...
        <script>
          ...
          const updateStats = async () => {
            try {
              ...
              const uptimeText =
                document.getElementById('uptime-text');

              const coordsText =
                document.getElementById('coords-text');
...
function startSelfPing() {
  ...
  console.log(
    '[KeepAlive] Self-ping system started (every 10 min)'
  );
}
...
function initializeModules(
  ...
  console.log(
    '[Modules] Initializing all modules...'
  );
